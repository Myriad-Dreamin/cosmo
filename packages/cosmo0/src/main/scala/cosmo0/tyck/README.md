...
prefix name-resolution facts recorded by elaboration, then resolves aliases,
classes, traits, impls, standard generic descriptors, type-dependent method and
selector calls, patterns, mutability, and expression result types, while
delegating type relations and dependent-pattern hooks to `MlttTypeChecker`.
