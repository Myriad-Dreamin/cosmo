...
object CppBackend:
  def apply(module: LirModule): CppBackend =
    new CppBackend(module, StandardGenericDescriptors.all)
...
final class CppBackend(
  ...
  private def backendRequirements: List[BackendRequirement] =
