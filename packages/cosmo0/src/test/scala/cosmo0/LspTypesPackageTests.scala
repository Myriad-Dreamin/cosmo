...
class LspTypesPackageTests extends munit.FunSuite:
  ...
  test("full lspt-flavored generated files are checked in"):
    ...
    files.foreach { name =>
      val path = s"packages/lsp-types/src/lsp/full/$name"
    ...
    val base = ParserFixtureManifest.readFile("packages/lsp-types/src/lsp/full/base.cos")
    val requests = ParserFixtureManifest.readFile("packages/lsp-types/src/lsp/full/request.cos")
    val notifications = ParserFixtureManifest.readFile("packages/lsp-types/src/lsp/full/notification.cos")
    val structs = ParserFixtureManifest.readFile("packages/lsp-types/src/lsp/full/structs.cos")
