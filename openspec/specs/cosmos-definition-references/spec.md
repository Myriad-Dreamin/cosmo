# cosmos-definition-references Specification

## Purpose

Define current-open-document semantic navigation for Cosmos language-server
definition and references requests, including deterministic LSP location JSON,
supported symbol kinds, empty-result behavior, and server wiring through
`ls-base`.
