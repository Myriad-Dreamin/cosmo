...
- [ ] 1.1 Define the cosmo1 Stage 1 primitive descriptor set and core0 standard capability set required for source loading, spans, diagnostics, tokens, lexing-oriented structures, and text output.
...
- [ ] 2.2 Use only accepted cosmo0 subset constructs and implemented primitive descriptors or staged standard capabilities.
...
- [ ] 4.3 Document the process for extending Stage 1 validation as additional primitive descriptors, standard capabilities, and lowering support become available.
