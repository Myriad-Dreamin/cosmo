...
- `cosmo-eval`: Defines the common eval contract implemented independently by
  ...
  paths, and benchmark reporting for future compile-time evaluation and REPL
  consumers.
...
- Establishes the dependency that later compile-time evaluation probes and REPL
  mode can use without adding the full macro system.
