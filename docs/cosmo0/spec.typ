...
- `compile-time-evaluation.typ` owns `ConstEval`, `ProviderEval`, macro output purity, full C++ compile-time execution through `cosmo-jit-sys`, and target runtime separation.
